...
import { StationListEdsComponent } from './station-list-eds.component';

describe('StationListEdsComponent', () => {
  let component: StationListEdsComponent;
  let fixture: ComponentFixture<StationListEdsComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [StationListEdsComponent]
    })
      .compileComponents();
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(StationListEdsComponent);
