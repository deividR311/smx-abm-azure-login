...
import { UserAdminSaveComponent } from './user-admin-save.component';

describe('UserAdminSaveComponent', () => {
  let component: UserAdminSaveComponent;
  let fixture: ComponentFixture<UserAdminSaveComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [UserAdminSaveComponent]
    })
      .compileComponents();
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(UserAdminSaveComponent);
